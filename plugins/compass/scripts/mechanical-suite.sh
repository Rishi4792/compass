...
CHILDREN="dup-fact-check vacuous-assert-check unwired-gate-check shell-trap-check doctrine-wired-check self-arm-check cap-enforce-check outside-in-reachable incremental-check readable-pages-check gold-diff-check argshift-check copy-reaches-check leak-scan-check secret-corpus-check armed-check"
